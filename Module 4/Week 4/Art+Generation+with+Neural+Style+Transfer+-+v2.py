...
content_image = scipy.misc.imread("images/eu2.jpg")
...
style_image = scipy.misc.imread("images/che.jpg")
imshow(style_image)
...
### START CODE HERE ### (1 line)
J = total_cost(J_content, J_style, alpha = 5, beta = 45)
### END CODE HERE ###
...
model_nn(sess, generated_image, 800)
